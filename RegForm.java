...
public class RegForm {
	...
	public RegForm() {
		...
		textFieldfirstN.setBounds(107, 68, 251, 38);
		...
		lblMobileNumber.setBounds(10, 284, 87, 26);
		...
		lblRepeatPassword.setBounds(10, 423, 87, 26);
		...
		btnRegister.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			    ...
			    try {
			        ...
			        if(isExisting() == true) {
			        JOptionPane.showMessageDialog(btnRegister, "Email/Mobile number already exists!");
			        
			        }
			        else if (first.equals("") || last.equals("") || password2.equals("") || mobile.equals("") || password.equals("") || email.equals("")){
			        JOptionPane.showMessageDialog(btnRegister, "FILL EVERYTHING UP!");
			        }
			        else if(email.contains("@") == false || email.contains(".com") == false) {
			        JOptionPane.showMessageDialog(btnRegister, "Invalid Email!!");
			        }
			        ...
			        {
			        JOptionPane.showMessageDialog(btnRegister, "Password too weak! Make sure to add Special Characters such as '!' or '@'");
			        }


			        else {
			        	JOptionPane.showMessageDialog(btnRegister, "Account Created!");
