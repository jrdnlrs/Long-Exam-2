...
public class login {
	...
	
	{
		...
		lblStudentType = new JLabel("Student Type");
		lblStudentType.setFont(new Font("Arial", Font.PLAIN, 14));
		lblStudentType.setBounds(119, 252, 105, 14);
		...
		btnCheckTuition = new JButton("Check Tuition Fee");
		...
		btnCheckTuition.addActionListener(new ActionListener() {
			...
			if(id.equals("") || first.equals("") || last.equals("") || data.equals("")) {
				JOptionPane.showMessageDialog(comboStudentType, "FILL EVERYTHING UP!");
			}
		...
		btnCheckTuition.setBounds(119, 496, 161, 44);
		...
		btnEnroll.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(id.equals("") || first.equals("") || last.equals("") || data.equals("")) {
					...
					JOptionPane.showMessageDialog(comboStudentType, "Student Enrolled! Wait for the receipt.");
					frame.dispose();
					...
					JLabel lblFirstName = new JLabel("First Name:" + first);
					...
					JLabel lblLastName = new JLabel("Last Name:" + last);
					...
					JLabel lblStudentType = new JLabel("Student Type:" + color);
					...
					JLabel lblThanks = new JLabel("THANK YOU FOR ENROLLING!");
					lblThanks.setFont(new Font("Arial", Font.BOLD, 25));
					lblThanks.setBounds(23, 232, 379, 122);
					lblThanks.setBackground(null);
					frame2.getContentPane().add(lblThanks);
					
					JLabel lbldate = new JLabel("Date: 3/6/2023");
					...
					JLabel lblTuitionFee = new JLabel("Status: PAID");
